...
function App() {
    ...
    const mySubmit = async (e: React.MouseEvent): Promise<void> => {
        e.preventDefault();
        console.log("clicked");
    ...
    return (
        <>
            <div id="container">
                ...
                <div id="links">
                    <a href="https://github.com/devesh-y" target="_blank">
                    ...
                    <a href="https://www.linkedin.com/in/devesh-y/" target="_blank">
